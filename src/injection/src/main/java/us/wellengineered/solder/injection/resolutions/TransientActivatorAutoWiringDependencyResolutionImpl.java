...
import us.wellengineered.solder.injection.InjectionUtils;
...
public final class TransientActivatorAutoWiringDependencyResolutionImpl<TResolution> extends AbstractDependencyResolution<TResolution>
{
	public TransientActivatorAutoWiringDependencyResolutionImpl(Class<? extends TResolution> instanceClass)
	{
	...
	protected TResolution coreResolve(DependencyManager dependencyManager, Class<? extends TResolution> resolutionClass, String selectorKey) throws Exception
	{
		...
		instance = InjectionUtils.resolveInstanceAssignableToClass(this.getInstanceClass(), dependencyManager, selectorKey, true);
