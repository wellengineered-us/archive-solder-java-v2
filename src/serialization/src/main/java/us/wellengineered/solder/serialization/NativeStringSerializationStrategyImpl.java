...
public class NativeStringSerializationStrategyImpl extends AbstractCommonSerializationStrategy<StringBuilder, StringBuilder>
{
	public NativeStringSerializationStrategyImpl()
	{
